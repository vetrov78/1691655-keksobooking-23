...
const ADS_NUMBER = 10;
const avatarNumbers = Array.from({length: ADS_NUMBER}, (v,k)=>`0${k+1}`.slice(-2));
const COORDINATE_ACCURACY = 5;
const LATITUDE_MIN = 35.65000;
const LATITUDE_MAX = 35.70000;
const LONGITUDE_MIN = 139.70000;
const LONGITUDE_MAX = 139.80000;
const priceInterval = {MIN: 1, MAX: 10e+7};
const flatTypes = ['palace', 'flat', 'house', 'bungalow', 'hotel'];
const roomQuantity = {MIN: 1, MAX: 10};
const guestQuantity = {MIN: 1, MAX: 15};
...
const getRandomAvatarNumber = () => avatarNumbers.splice(getRandomInt(0, avatarNumbers.length - 1), 1);
...
const createNewAd = () => {
  ...
  return {
    ...
    offer: {
      ...
      address: `${lat}, ${lng}`,
      price: getRandomInt(priceInterval.MIN, priceInterval.MAX),
      type: getRandomArrayElement(flatTypes),
      rooms: getRandomInt(roomQuantity.MIN, roomQuantity.MAX),
      guests: getRandomInt(guestQuantity.MIN, guestQuantity.MAX),
      ...
      photos: getRandomArrayFromArray(photosList),
    },
  };
};
